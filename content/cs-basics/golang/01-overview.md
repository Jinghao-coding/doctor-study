...
Go 是 Google 设计的「面向工程的系统编程语言」，核心哲学是**简单优于复杂、组合优于继承、CSP 并发优于共享内存**；面试要能说清云原生场景为什么选 Go、以及什么时候不应该用 Go。
...
<div class="qa-summary">一句话：Go 不是追求语言特性最多的语言，而是追求团队协作效率最高、大规模工程最稳的语言。</div>
</div>
