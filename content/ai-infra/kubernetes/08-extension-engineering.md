...
K8S 扩展工程要区分 CRD/Controller、Admission Webhook、Scheduler Plugin、Operator 和 GitOps。
...
| 面试抓手 | 回答时强调 reconcile、幂等、状态机和升级回滚。 |
...
K8S 扩展工程要区分 CRD/Controller、Admission Webhook、Scheduler Plugin、Operator 和 GitOps。 回答时强调 reconcile、幂等、状态机和升级回滚。
